#Codigo para visualizacion de explosiones de particulas
#Fuente: https://www.dropbox.com/s/yogmtrpgd10ywec/particle.zip
#Demo disponible en: https://www.youtube.com/watch?v=ikGvd18oYg4
...
def crear_meteoro(my_x,my_y):
	...
	for particle in particle_xysize:
		velocity.append(random.randint(1, 5))
		...
		for element in range(len(particle_xysize)):
			...
			if particle_xysize[element][2] > 0:
				...
				for i in range(100):
					...
					particle_xysize[element][0], particle_xysize[element][1] = my_x, my_y
					break
